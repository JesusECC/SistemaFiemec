      ...
      <table class="principal" width="100%"> 
        <thead class="principal"> 
          ...
          <tr class="principal"> 
            ...
            <td class="principal" align="center" style="border: 1px solid black">S/.{{($det->precio_venta*$det->cantidad)-(($det->cantidad*$det->precio_venta)*($det->descuento/100))}}</td>
          </tr>
          @endforeach
        ...
        <tfoot>
            <tr style="font-weight: bold;">
              ...
              <td colspan="2" align="center" style="border: 1px solid #323639;"> S/. {{$proforma->subtotal}}</td>
            </tr>
            <tr style="font-weight: bold;">
              ...
              <td colspan="2" align="center" style="border: 1px solid #323639"> S/. {{round(($proforma->subtotal)*($proforma->igv/100),2)}}</td>
            </tr>
            <tr style="font-weight: bold;">  
