...
<div class="form-group">
	...
	<input type="text" name="cargo" class="form-control" required value="{{$Empleado->cargo}}">	
</div>

<div class="form-group">
	<label for="sueldo">sueldo</label>
	<input type="text" name="sueldo" class="form-control" required value="{{$Empleado->sueldo}}">	
</div>

<div class="form-group">
	<label for="fecha_inicio">Fecha de inicio</label>
	<input type="date" name="fecha_inicio" class="form-control" required value="{{$Empleado->fecha_inicio}}">	
</div>

<div class="form-group">
	<label for="fecha_fin">fecha de fin</label>
	<input type="text" name="fecha_fin" class="form-control" required value="{{$Empleado->fecha_fin}}">	
</div>
