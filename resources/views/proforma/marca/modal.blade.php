<div class="modal fade " aria-labelledby="myModalLabel"  role="dialog" tabindex="-1" id="modal-delete-{{$m->idMarca}}"" style="padding-left: 17px;border-radius:0px !important;">
{{Form::Open(array('action'=>array('ControllerMarca@destroy',$m->idMarca),'method'=>'delete'))}}
