<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$empl->idEmpleado}}">

{{Form::Open(array('action'=>array('ControllerEmpleados@destroy',$empl->idEmpleado),'method'=>'delete'))}}
