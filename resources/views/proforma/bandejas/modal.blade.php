          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-transparent text-center p-md">
                ...
                <p class="p-text-delete">Al eliminar la siguiente Proforma Bandeja con la Serie<span style="color: red"> {{$prof->serie_proforma}}</span>  no volvera a verlo en la lista </p>
              </div>
            </div>
            <h3>¿Desea eliminar la proforma bandeja?</h3>
          </div>
